...
public interface VentaRepository extends JpaRepository<Venta, Integer> {
        ...
        List<Venta> findTop5ProductosMasVendidos(LocalDate fechaInicio);
        ...
        List<Venta> findTop5ProductosMenosVendidos(LocalDate fechaInicio);
        ...
        List<Venta> findVentasPorDiaUltimos30Dias(LocalDate fechaInicio);
        ...
        "GROUP BY v.fecha " +
        "ORDER BY v.fecha ASC")
        List<Venta> findGananciasPorDiaUltimos30Dias(LocalDate fechaInicio);
